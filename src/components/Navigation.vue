<template>
<div id="Navigation">
  <div class="logo___responsive" v-show="burger">
  ...
  <nav class="menu">
    <ul>
      <li v-for="option in menu" v-bind:class="option.class" @click="closeMenu()">
  ...
  <div class="social">
    <a href="https://linkedin.com/in/guillaumeduhan" target="_blank">
        <img src="../assets/linkedin-logo.png" alt="linkedin">
      </a>
    <a href="https://github.com/guillaumeduhan/BANQUE-POP-APP-WEB" target="_blank">
